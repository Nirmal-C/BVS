                        ...
                        <div class="title-bg">
                            <div class="container-s">
                                <div class="container_12">
                                    <div class="grid_12">
                                        <h1 class="title">NewsLetter - Admin</h1>
                                    </div>
                                </div> 
                            </div>
                        ...
                        <div class="card" >
                            ...
                            <div class="card-footer">
                                <div class="text-right">
                                    <button id="addNewsBtn" class="btn btn-sm waves-effect waves-light btn-danger"><i class="icon feather icon-plus"></i>Add NewsLetter</button>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            $(document).on('click', '.delrec', function () {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return fetch('letter/deactivate-letter', {
                            method: 'POST',
                    ...
                    if (result.value) {
                        if (result.value.status !== 200) {
                            ...
                            Swal.fire('Successfull!', 'NewsLetter has been Deactivated !', 'success');
                            dtable.ajax.reload();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                        }
            ...
            $(document).on('click', '.rerec', function () {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "NewsLetter Will be Activated!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch('letter/reactivate-letter', {
                            method: 'POST',
                            body: new URLSearchParams({
                                id: id
                            })
                    ...
                    if (result.value) {
                        if (result.value.status !== 200) {
                            ...
                            Swal.fire('Successfull!', 'NewsLetter has been Activated !', 'success');
                            dtable.ajax.reload();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                        }
            ...
            // Add an event listener to the "Add NewsLetter" button
                ...
                if (mode === 'save') {
                    ...
                    fetch('letter/save', {
                        ...
                        if (!response.ok) {
                            ...
                            Swal.fire('Successful!', 'NewsLetter has been successfully saved', 'success');
                            clearForm();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                            dtable.ajax.reload();
                    ...
                    $.ajax({
                        url: 'letter/update', // Replace with the actual update endpoint
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function (response) {
                            if (response.status === 200) {
                                Swal.fire('Successful!', 'NewsLetter details updated successfully', 'success');
                                clearForm();
                                $('#formSection').hide();
                                $('#tableSection').fadeIn();
                                dtable.ajax.reload();
                        ...
                        error: function (xhr, status, error) {
                            ...
                            console.log(status);
                            console.log(error);
                            Swal.fire('Error!', 'Failed to update NewsLetter details', 'error');
                        }
                    });
                }
            });
