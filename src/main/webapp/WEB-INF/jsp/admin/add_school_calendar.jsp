    ...
    <body>
                        ...
                        <div class="card" >
                            ...
                            <div class="card-footer">
                                <div class="text-right">
                                    <button id="addCalendarEventBtn" class="btn btn-sm waves-effect waves-light btn-danger"><i class="icon feather icon-plus"></i>Add Calendar Event</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-block p-b-0">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group" style="width: 75rem">
                                        <label for="description">Please Enter the Description Here<span class="text-danger">*</span></label>
                                        <input id="description" type="text" name="description" class="form-control"  required autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group" style="width: 75rem">
                                        <label for="date">Please Enter the Date Here<span class="text-danger">*</span></label>
        ...
        <script>
            ...
            $(document).on('click', '.editrec', function () {
                ...
                fetch('calendar/update-calendar/' + id).then(resp => resp.json())
                        .then((data) => {
                            clearForm();
            ...
            $(document).on('click', '.delrec', function () {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "This Calendar Event Will be Deleted!",
                    icon: 'warning',
                    ...
                    preConfirm: () => {
                        return fetch('calendar/deactivate-calendar', {
                            method: 'POST',
                    ...
                    if (result.value) {
                        if (result.value.status !== 200) {
                            ...
                            Swal.fire('Successfull!', 'Calendar Event has been Deactivated !', 'success');
                            dtable.ajax.reload();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                        }
            ...
            $(document).on('click', '.rerec', function () {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Calendar Event Will be Activated!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch('calendar/reactivate-calendar', {
                            method: 'POST',
                            body: new URLSearchParams({
                                id: id
                            })
                    ...
                    if (result.value) {
                        if (result.value.status !== 200) {
                            ...
                            Swal.fire('Successfull!', 'Calendar Event has been Activated !', 'success');
                            dtable.ajax.reload();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                        }
            ...
            $('#addCalendarEventBtn').click(function () {
            ...
            $('#saveBtn').click(function () {
                ...
                return fetch((($('#saveBtn').data('mode') === 'save') ? 'calendar/save-calendar' : 'calendar/update-calendar'), {
                    method: 'POST',
                    body: new URLSearchParams({
                        id: $('#saveBtn').data('id'),
                    ...
                    if (!response.ok) {
                        ...
                        Swal.fire('Successfull!', 'Calendar Event has been successfully saved');
                        clearForm();
                        $('#formSection').hide();
                        $('#tableSection').fadeIn();
                        dtable.ajax.reload();
