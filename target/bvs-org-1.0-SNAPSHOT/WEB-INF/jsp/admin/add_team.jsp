    ...
    <body>
                        ...
                        <div class="title-bg">
                            <div class="container-s">
                                <div class="container_12">
                                    <div class="grid_12">
                                        <h1 class="title">Our Team - Admin</h1>
                                    </div>
                                </div> 
                            </div>
                        ...
                        <div class="card" >
                            ...
                            <div class="card-footer">
                                <div class="text-right">
                                    <button id="addTeamBtn" class="btn btn-sm waves-effect waves-light btn-danger"><i class="icon feather icon-plus"></i>Add Team</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-block p-b-0">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        <label for="team">Please Add Your Team Name Here<span class="text-danger">*</span></label>
                                        <input id="team" type="text" name="team" class="form-control"  required autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="text">
                                                <button id="addBtn" class="btn btn-sm waves-effect waves-light btn-danger">
                                                    <i class="icon feather icon-plus"></i>Add Member
                                                </button>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            ...
            document.getElementById('addBtn').addEventListener('click', function () {
                ...
                var teamNameCell = newRow.insertCell(0);
                ...
                teamNameInput.autocomplete = 'off';
                ...
                addAttachmentRow(teamNameInput.value);
            });

            function clearForms() {
                // Clear Team Members Name input
        ...
        <script>
            ...
            $(document).on('click', '.delrec', function () {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "This Team Members Will be Deleted!",
                    icon: 'warning',
                    ...
                    preConfirm: () => {
                        return fetch('team/deactivate-content', {
                            method: 'POST',
                    ...
                    if (result.value) {
                        if (result.value.status !== 200) {
                            ...
                            Swal.fire('Successfull!', 'Team Members has been Deactivated !', 'success');
                            dtable.ajax.reload();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                        }
            ...
            $(document).on('click', '.rerec', function () {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Team Members Will be Activated!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch('team/reactivate-content', {
                            method: 'POST',
                            body: new URLSearchParams({
                                id: id
                            })
                    ...
                    if (result.value) {
                        if (result.value.status !== 200) {
                            ...
                            Swal.fire('Successfull!', 'Team Members has been Activated !', 'success');
                            dtable.ajax.reload();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                        }
            ...
            $(document).on('click', '.editrec', function () {
                ...
                fetch('team/content-details/' + id)
                        .then(resp => resp.json())
                        .then((resp) => {
                            let content = resp.data.content;
                            $('#team').val(content.team);
                            ...
                            attachments.forEach((attachment) => {
                                ...
                                teamNameCell.textContent = attachment.name;
                ...
                if (mode === 'save') {
                    ...
                    fetch('team/save-attachment', {
                        ...
                        if (!response.ok) {
                            ...
                            Swal.fire('Successful!', 'Team Members has been successfully saved', 'success');
                            clearForms();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                            $('#navTab').fadeIn();
                    ...
                    tableRows.forEach((row, index) => {
                        let teamNameInput = row.querySelector('input[name="teamName"]');
                    ...
                    fetch('team/update-attachment', {
                        ...
                        if (!response.ok) {
                            ...
                            Swal.fire('Successful!', 'Team Members details updated successfully', 'success');
                            clearForms();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                            $('#navTab').fadeIn();
                        ...
                        Swal.fire('Error!', 'Failed to update Team Members details', 'error');
                    });
                }
