...
<html>
    ...
    <body>
        ...
        <div class="title-bg">
            <div class="container-s">
                <div class="container_12">
                    <div class="grid_12">
                        <h1 class="title">Projects & Events</h1>
                    </div>
                </div> 
            </div>
        ...
        <div class="para" >
            ...
            <ul>
                <li><a href="Project-Garden">BVS Property Beautifying & Graden Enhancement Project</a></li>  
            </ul>
        </div>
        ...
        <script>
            document.getElementById("papFormLink").addEventListener("click", function (event) {
